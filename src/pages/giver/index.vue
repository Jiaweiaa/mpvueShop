<template>
  <div class="myOrder">
		  ...
		  <van-tab title="待发货">
			  <div class="content">
					  ...
					  <van-collapse-item name="1">
						  <view slot="title">
							  <view class="btnStyle" plain >
								  ...
								  <van-icon v-if="startDate !== '开始时间' || endDate !== '结束时间'" @click.stop="clearTime" name="cross" color="#999" custom-class="iconStyle"/>
							  </view>
						  </view>
				  ...
				  <div style="width: 100%; text-align: center;margin-top: 5px;">
					  <div class="title" v-if="allCount!=''&&orderList.length >= allCount && orderList.length > 0">
						  <span>—</span>
						  <span>我也是有底线的</span>
						  <span>—</span>
					  </div>
	  ...
	  <van-button v-if="searchParams.orderType == 4" style="position: fixed; right: 30px; bottom: 50px;" size="small" plain hairline @click="toggleClick" type="primary">一键发货</van-button>
  </div>
</template>
