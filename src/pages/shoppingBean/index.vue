...
<template>
  <div class="my">
    ...
    <div class="btnRow">
      <van-button custom-class="btnStyle" @click="getIntegral" type="primary">购物豆充值</van-button>
      <van-button custom-class="btnStyle" @click="integralList" type="default">购物豆明细</van-button>
    </div>
...
import { getMemberAmount, rechargeShoppingBeans,scanQrCode2AddScore } from "@/api/shopping/index";
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      this.score = data.data.result.shoppingBeans;
    },
